...
# MindIE Motor Coordinator integration (Motor is a routing component like the
# SGLang router / vLLM proxy; its endpoint derives from ROUTER_ROLE_NAME/ROUTER_PORT)
